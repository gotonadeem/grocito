    ...
    <section class="breadcrumbs-custum">
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">{{$catData['name']}}</li>
            </ul>
        </div>
    </section>
                ...
                <div class="col-md-9">
                    ...
                    <div class="product-list-sec">
                        <div class="d-flex justify-content-between align-items-center bg-gray product-title-sort">
                            <h4 class="title">{{$catData['name']}}</h4>
                        ...
                        <div class="product-listing my-3 " id="product_listing">
                            <div class="row">
                                ...
                                <?php $catProduct = Helper::getProductByCat($catId,$subCatId); ?>
								@if(count((array)$catProduct)>0)
                                        ...
                                        <div class="item-content">
                                            ...
                                            <div class="custom-select-size">
                                                ...
                                                <select name="seller_id" class="custom-select  get-seller-id-{{$pList->id}} get-product-item">
                                                    <option value="{{!is_null($productSeller->user_name)?$productSeller->user_name->id:""}}">{{$productSeller->user_name->username}} </option>
                                                    @foreach($sellerList as $vs)
                                                    <option value="{{!is_null($vs->get_seller)?$vs->get_seller->id:""}}">{{!is_null($vs->get_seller)?$vs->get_seller->username:""}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="custom-select-size">
