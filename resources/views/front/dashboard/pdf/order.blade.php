...
<body >
<div class="print-header" style="background-color:#5899CC; text-align:center; padding:10px 0px;">
  <img  style="width:200px" src="{{ URL::asset('/public/images/logo.png') }}">
</div>
...
<table style="width:100%" width="100%" class="table invoice-table" border="1">
  ...
  <tr>
    ...
    <th style='font-weight:normal'>Business Name</th>
