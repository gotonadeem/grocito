    ...
    <div class="seller-modal_login">
      <div class="form-v8-content"> 
	   ...
	   <div class="login_title">
          <h3 class="title-login">Verify Otp</h3>
        ...
        <div class="container-fluid">
		 {{ Form::open(array('url' => 'seller/verify-otp-seller','class'=>'form-detail animate','id'=>'verify_otp_seller','name'=>'seller_forgot_password')) }}
      
          <div class="form-row">
            <label class="form-row-inner">
              <input type="number" name="otp" id="otp" class="input-text" required="" aria-required="true">
              <span class="label"><i class="fa fa-mobile" aria-hidden="true"></i> Otp</span> <span class="border"></span> </label>
          </div>
