                    ...
                    <div class="order-product relative checkbox-present">
                        ...
                        <div class="border relative">
                            <div class="flex-container clearfix">
								...
								?>
                                <span class="img-inline-img"><img id="myImg_<?=$ks?>_<?=$vs->order_id; ?>" onclick="zoom_image(this.id)" src="{{ URL::asset('public/admin/uploads/product') }}/{{$image}}" alt="<?=$image?>" class="image-zoom"></span>
                               <?PHP endforeach; ?> 
