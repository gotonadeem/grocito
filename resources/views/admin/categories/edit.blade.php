                ...
                <div class="ibox float-e-margins">
                    ...
                    {{ Form::model($category,array('url' => ['admin/category/update/'.$category->id],'class'=>'form-horizontal','method'=>'post','enctype'=>'multipart/form-data')) }}
                            <div class="form-group row">
                             ...
                             <div class="form-group row">
                                <label for="iamge" class="col-md-3 control-label">Image </label>
                                <div class="col-md-6">
                                    {{Form::file('image')}}
                        ...
                        <div class="form-group row">
                            <label for="iamge" class="col-md-3 control-label">Icon For App </label>
                            <div class="col-md-6">
                                {{Form::file('app_icon')}}
                                <div class="error-message">{{ $errors->first('app_icon') }}</div>
                                <input type="hidden" value="{{ $category->app_icon}}" name="old_icon">
                            </div>
                        </div>
                            <div class="form-group row">
