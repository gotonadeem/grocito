...
////load the data......................................................
    ...
    dataTable = $('#user-notification-table').DataTable({
        ...
        "ajax":{
            ...
            url : BASE_URL+'/admin/site-setting/get-user-notification', // json datasource
...
function deleteItem(id){
    ...
    if (result) {
        ...
        $.ajax({
            ...
            url: BASE_URL+'/admin/site-setting/user-notification/delete',
...
function publishItem(id){
    ...
    if (result) {
        ...
        $.ajax({
            ...
            url: BASE_URL+'/admin/site-setting/user-notification/publish',
