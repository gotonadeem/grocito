...
dataTable = $('#customer-wallet-table').DataTable({
    // pageLength: 25,
    responsive: true,
    serverSide: true,
    "oLanguage": {
    ...
    "ajax":{
        ...
        url : BASE_URL+'/admin/customer/getCustomerWalletData', // json datasource
...
dataTable = $('#wallet-Referral-table').DataTable({
    // pageLength: 25,
    responsive: true,
    serverSide: true,
    "oLanguage": {
    ...
    "ajax":{
        ...
        url : BASE_URL+'/admin/customer/getCustomerReferralWalletData', // json datasource
